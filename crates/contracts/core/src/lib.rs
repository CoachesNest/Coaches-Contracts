...
pub enum Error {
    ...
    InvalidResolutionAmount = 19, // Resolution amounts don't sum to available amount
    SessionNotDisputed = 20,     // Session is not in Disputed status
    ResolutionFeeError = 21,     // Error calculating resolution fees
}
