...
fn test_storage_persistence_multiple_sessions_across_upgrade() {
    ...
    let contract_after = CoachesContractClient::new(&env, &contract.address);
...
fn test_storage_persistence_comprehensive_lifecycle() {
    ...
    let contract_v2 = CoachesContractClient::new(&env, &contract.address);
    ...
    let contract_v3 = CoachesContractClient::new(&env, &contract.address);
